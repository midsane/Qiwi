...
export default function BreathingExercise() {
  ...
  const calculatePoints = () => {
    // Simple point calculation: 1 point per second completed
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-600 to-purple-700 flex flex-col px-4 py-8 text-white">
      <header className="flex justify-between items-center mb-8">
        <button onClick={resetExercise} className="p-2 hover:bg-white/10 rounded-full transition-colors">
          {selectedPattern ? <ChevronLeft size={24} /> : <X size={24} />}
        </button>
