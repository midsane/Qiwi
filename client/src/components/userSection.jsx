...
export const UserSection = () => {
    ...
    return (<>
                    ...
                    {avatarArr.map((a, i) =>
                        ...
                        >
                            <motion.img 
                                initial={{opacity:0.8}}
                                animate={{opacity:1}}
                                className="w-16 hover:scale-105 duration-75 aspect-square rounded-full object-cover border border-mgreen" 
                                src={a} 
                            />
                        </motion.div>
                    )}
        ...
        <div className="flex gap-2 justify-center items-center">
            <div className="rounded-full group relative w-20 aspect-square bg-black" >
                <img className="w-20 aspect-square rounded-full object-cover border border-mgreen" src={currentAvatar} />
            ...
            <div className="flex flex-col h-full justify-center items-center ">
                ...
                className="flex gap-2 items-start">
                    ...
                    className="opacity-80" >xp {"1"}</motion.p>
                    <motion.p 
                        animate={{ x: [0, 10, 0] }}
                        transition={{ repeat: 3, duration: 2 }}
                    className="opacity-80" >level {"1"}</motion.p>
                </motion.div>
